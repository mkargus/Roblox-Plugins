...
RedTitle.BackgroundTransparency = 0.5
RedTitle.BorderSizePixel = 0
RedTitle.Position = UDim2.new(0, 5, 0, 35)
RedTitle.Size = UDim2.new(0.5, -5, 0, 20)
...
RedTitle.Parent = MainFrame

local RedValue = Instance.new('TextBox')
RedValue.BackgroundColor3 = Color.Black
RedValue.BackgroundTransparency = 0.5
...
RedValue.Parent = RedTitle

local RedSlider = Instance.new('ScrollingFrame')
RedSlider.BackgroundColor3 = Color.Black
RedSlider.BackgroundTransparency = 0.5
...
BlueTitle.BackgroundTransparency = 0.5
BlueTitle.BorderSizePixel = 0
BlueTitle.Position = UDim2.new(0, 5, 0, 105)
BlueTitle.Size = UDim2.new(0.5, -5, 0, 20)
...
ListLayout.Parent = SelectionFrame
...
function SetMaterialColor()
  local Material = Enum.Material[MaterialList[Settings.MaterialSelected].Enum]
  local UserColor = Color3.fromRGB(Settings.R, Settings.G, Settings.B)
  if Material == Enum.Material.Water then
    workspace.Terrain.WaterColor = UserColor
  else
    workspace.Terrain:SetMaterialColor(Material, UserColor)
  end
end
